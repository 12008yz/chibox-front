        ...
        <div className="flex max-w-7xl w-full items-center justify-between">
          {left.title !== 'hide' ? (
            <div className="w-72 h-56 notched bg-[#CF3464] flex items-center justify-center">
              <div className="w-[calc(100%-4px)] h-[calc(100%-4px)] notched bg-[#111112] hover:bg-opacity-95 transition-opacity flex flex-col items-start justify-center px-6">
                <div className="flex flex-col">
                  ...
                  <Link to={left?.link}>
                    <div className="flex items-center gap-2 mt-2 text-[#70699b] hover:text-[#CF3464] transition-colors">
                      {t('banner.go_to_page')}
                    </div>
                  </Link>
                </div>

...
const StatusDashboard: React.FC<StatusDashboardProps> = ({
  ...
  const statusConfig = {
    1: { name: t('homepage.status_tier_1'), icon: <img loading="lazy" src="/images/status.webp" alt="Статус" width="128" height="128" className="w-full h-full object-contain aspect-square" />, color: 'from-gray-400 to-gray-600', bonus: 2 },
    2: { name: t('homepage.status_tier_2'), icon: <img loading="lazy" src="/images/status+.webp" alt="Статус+" width="128" height="128" className="w-full h-full object-contain aspect-square" />, color: 'from-blue-400 to-purple-600', bonus: 3 },
    3: { name: t('homepage.status_tier_3'), icon: <img loading="lazy" src="/images/status++.webp" alt="Статус++" width="128" height="128" className="w-full h-full object-contain aspect-square" />, color: 'from-yellow-400 to-red-500', bonus: 5 }
  };
  ...
  const bonusActivities: BonusActivity[] = [
    {
      ...
      icon: <img loading="lazy" src="/images/status1.webp" alt="Крестики-нолики" width="128" height="128" className="w-full h-full object-contain aspect-square"/>,
      color: '',
      available: true,
    ...
    },
    {
      ...
      icon: <img loading="lazy" src="/images/bonus-safe.webp" alt="Сейф" width="128" height="128" className="w-full h-full object-contain aspect-square"/>,
      color: '',
      available: true,
    ...
    },
    {
      ...
      icon: <img loading="lazy" src="/images/status4.webp" alt="Обмен предметов" width="128" height="128" className="w-full h-full object-contain aspect-square"/>,
      color: '',
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-full md:max-w-none px-4 md:px-0 z-50 min-h-[400px]">
      <Title title={name} />

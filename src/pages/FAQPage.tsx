  ...
  const faqData = [
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: 'Мы принимаем банковские карты Visa/Mastercard/Мир и электронные кошельки.'
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'Что делать, если при выводе предмета написано «предмет не найден у бота»?',
          a: 'Иногда нужный предмет временно отсутствует в инвентаре бота. Вам придёт уведомление с выбором: получить компенсацию в ChiCoins на сумму предмета или подождать — мы повторим попытку вывода позже. Подробнее — в разделе 6.3 Пользовательского соглашения.'
        }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: 'Есть три уровня: Статус (+2% к дропу), Статус+ (+3% к дропу) и Статус++ (+5% к дропу). Каждый последующий уровень дает больше преимуществ.'
        },
        {

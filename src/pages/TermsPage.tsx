            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-800/50 border-l-4 border-orange-400 p-4 rounded">
                ...
                <p className="text-sm mb-2">
                  ...
                  а не азартная игра или казино. Пользователь приобретает виртуальную валюту ChiCoins, которую может
              ...
              <div className="bg-gray-800/30 p-4 rounded-lg">
                ...
                <ul className="list-disc ml-6 space-y-1">
                  ...
                  <li>Не могут быть обменены обратно на ChiCoins через нашу платформу</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="bg-gray-800/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-400 mt-2">
                  Минимальная сумма пополнения: 100 рублей. Комиссия платежной системы может взиматься
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-800/30 p-4 rounded-lg">
                ...
                <ul className="list-disc ml-6 space-y-2 text-sm">
                  <li>
                    <strong className="text-white">При пополнении на сумму более 15 000 рублей</strong>

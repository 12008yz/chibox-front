            ...
            <div className="space-y-4">
              <div className="bg-gray-800/30 p-4 rounded-lg">
                ...
                <ul className="list-disc ml-6 space-y-1">
                  ...
                  <li>Пройти регистрацию на платформе ChiBox исключительно через авторизацию Steam (другие способы регистрации не предусмотрены)</li>
                </ul>
              </div>
              ...
              <div className="bg-gray-800/30 p-4 rounded-lg">
                ...
                <ul className="list-disc ml-6 space-y-1">
                  <li>Безопасность и сохранность доступа к вашему аккаунту Steam, через который выполнен вход на ChiBox</li>
            ...
            <div className="space-y-4">
              <div className="bg-gray-800/30 p-4 rounded-lg">
                ...
                <ul className="list-disc ml-6 space-y-1 text-sm">
                  ...
                  <li>Ответ направляется на контактный email пользователя (при наличии в профиле) или через уведомления на платформе</li>

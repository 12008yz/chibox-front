          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-800/50 rounded-lg p-6 border-2 border-blue-500/50 hover:border-blue-400 transition-all">
              ...
              <div className="text-3xl font-bold text-white mb-4 flex items-center justify-center gap-2">
                1 911
                <img loading="lazy" src="/images/chiCoinFull.webp" alt="ChiCoins" className="w-8 h-8 inline-block object-contain align-middle self-center" width="32" height="32" />
              </div>
            ...
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700/50">
              <div className="flex justify-between items-start mb-3">
                ...
                <div className="text-2xl font-bold text-orange-400 flex items-center gap-1">
                  99
                  <img loading="lazy" src="/images/chiCoinFull.webp" alt="ChiCoins" className="w-6 h-6 inline-block object-contain align-middle self-center" width="24" height="24" />
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/30 text-center">
              <div className="text-lg font-bold text-orange-400 mb-1 flex items-center justify-center gap-1">
                17
                <img loading="lazy" src="/images/chiCoinFull.webp" alt="ChiCoins" className="w-4 h-4 inline-block object-contain align-middle self-center" width="16" height="16" />
              </div>
          ...
          <div className="space-y-4 text-gray-300">
            ...
            <div className="flex gap-3">
              ...
              <p>
                ...
                безопасные платежные системы (Robokassa, FreeKassa). Цены указаны в ChiCoins.
              </p>
            </div>
            ...
            <div className="mt-6 p-4 bg-blue-900/20 rounded-lg border border-blue-500/30">
              <p className="text-sm text-blue-200">
                <strong>Правовая информация:</strong> ИП Чикасов Денис Владимирович, ИНН 711204279301, ОГРНИП 326710000034852.
                Дата присвоения ОГРНИП: 22.05.2026.

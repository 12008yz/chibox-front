      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        <div className="bg-gray-800/50 rounded-xl p-8 border border-orange-500/30">
          ...
          <div className="space-y-4 text-gray-300">
            ...
            <div className="mt-6 p-4 bg-blue-900/20 rounded-lg border border-blue-500/30">
              <p className="text-sm text-blue-200">
                <strong>Правовая информация:</strong> ИП Чикасов Денис Владимирович, ИНН 711204279301.
                Применяется специальный налоговый режим «Налог на профессиональный доход» с 01.05.2025.
